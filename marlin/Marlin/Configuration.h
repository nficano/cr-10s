...
#define STRING_CONFIG_H_AUTHOR "Nick Ficano (v1.0.0)" // Original author or contributor.
...
// #define U_DRIVER_TYPE  TMC2208
// #define V_DRIVER_TYPE  TMC2208
// #define W_DRIVER_TYPE  TMC2208
...
#define CLIP_W 24 // 20mm clip width + 2mm buffer on each side
#define CLIP_H 13 // same height as before

// Obstacle Rectangles defined as { X1, Y1, X2, Y2 }
#define OBSTACLE1 {(31.75 - 2), 0, (31.75 + CLIP_W - 2), CLIP_H}
#define OBSTACLE2 {(X_BED_SIZE - 44.45 - CLIP_W + 2), 0, (X_BED_SIZE - 44.45 + 2), CLIP_H}
#define OBSTACLE3 {(31.75 - 2), (Y_BED_SIZE - CLIP_H), (31.75 + CLIP_W - 2), Y_BED_SIZE}
#define OBSTACLE4 {(X_BED_SIZE - 44.45 - CLIP_W + 2), (Y_BED_SIZE - CLIP_H), (X_BED_SIZE - 44.45 + 2), Y_BED_SIZE}
...
#define Z_SAFE_HOMING_X_POINT 140  // (mm) X point for Z homing
#define Z_SAFE_HOMING_Y_POINT 140  // (mm) Y point for Z homing
...
// Switch into SW mode after deploy. Makes output pulse longer.
// #define BLTOUCH_FORCE_SW_MODE

// Set default mode to 5V mode at Marlin startup (for BLTouch Smart 3.0)
#define BLTOUCH_SET_5V_MODE

// Enable voltage mode settings in LCD menu
 #define BLTOUCH_LCD_VOLTAGE_MENU

// Force probe into selected mode at startup
...
#define LIN_ADVANCE
  ...
  #define LA_K_START 0          // Use a different K factor at the start of the print
  #define LA_K_PERIOD 10        // Gradually increase K from LA_K_START to K over this many millimeters
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
#endif

// #define ARC_SUPPORT               // Disable this if you get "busy" errors
...
//#define POWER_LOSS_RECOVERY
  ...
  #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the head away from the print during power loss
...
//`#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) The length of filament to unload
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         50  // (mm) Length to purge after loading
  #define ADVANCED_PAUSE_PURGE_FEEDRATE       3  // (mm/s) Purge feedrate (after loading)
  #define PAUSE_PARK_NOZZLE_TIMEOUT         45  // (seconds) Time limit before the nozzle is turned off
  #define FILAMENT_CHANGE_ALERT_BEEPS       10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT        // Enable for XYZ steppers to stay powered during filament change.
#endif

//#define BABYSTEPPING
#if ENABLED(BABYSTEPPING)
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MULTIPLICATOR_Z  1       // Babysteps are very small. Increase for faster Z adjustment.
  #define BABYSTEP_MULTIPLICATOR_XY 1       // Babysteps are very small. Increase for faster XY adjustment.
